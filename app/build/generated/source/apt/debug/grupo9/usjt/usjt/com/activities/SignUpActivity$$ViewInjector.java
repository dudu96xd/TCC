...
public class SignUpActivity$$ViewInjector<T extends grupo9.usjt.usjt.com.activities.SignUpActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131230832, "field '_nameText'");
    target._nameText = finder.castView(view, 2131230832, "field '_nameText'");
    ...
    view = finder.findRequiredView(source, 2131230842, "field '_loginLink'");
    target._loginLink = finder.castView(view, 2131230842, "field '_loginLink'");
  }
